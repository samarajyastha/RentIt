...
public class RentElectroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rent_electro_layout);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(RentElectroActivity.this, AddActivity.class);
                intent.putExtra("item","electro");
                intent.putExtra("header","Add an Electro");
    ...
    public void populateData() {
        ...
        for (final AddInfo info : list
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(RentElectroActivity.this, DetailActivity.class);
