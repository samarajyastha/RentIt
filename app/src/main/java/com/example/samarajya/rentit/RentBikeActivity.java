...
public class RentBikeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rent_bike_layout);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(RentBikeActivity.this, AddActivity.class);
                intent.putExtra("item","bike");
                intent.putExtra("header","Add a Bike");
    ...
    public void populateData() {
        ...
        for (final AddInfo info : list
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(RentBikeActivity.this, DetailActivity.class);
