...
public class RentFashionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rent_fashion_layout);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(RentFashionActivity.this, AddActivity.class);
                intent.putExtra("item","fashion");
                intent.putExtra("header","Add a Fashion");
    ...
    public void populateData() {
        ...
        for (final AddInfo info : list
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(RentFashionActivity.this, DetailActivity.class);
