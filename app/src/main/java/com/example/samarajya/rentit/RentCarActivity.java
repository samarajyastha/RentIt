    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(RentCarActivity.this, AddActivity.class);
                intent.putExtra("item","car");
                intent.putExtra("header","Add a Car");
    ...
    public void populateData() {
        ...
        for (final AddInfo info : list
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(RentCarActivity.this, DetailActivity.class);
