...
public class RentCafeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rent_cafe_layout);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RentCafeActivity.this, AddActivity.class);
                intent.putExtra("item", "cafe");
                intent.putExtra("header", "Add a Cafe");
    ...
    public void populateData() {
        ...
        for (final AddInfo info : list
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(RentCafeActivity.this, DetailActivity.class);
